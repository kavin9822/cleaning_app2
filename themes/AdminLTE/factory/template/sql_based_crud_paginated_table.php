            ...
            <div class="row hidden-print">
                ...
                <div class="col-md-8 col-xs-10 text-right">
                    ...
                    <?php if ($wp): ?>
                        ...
                        <?php if(isset($popdf) || isset($dcpdf) || isset($dcpdf2)){?>
                             ...
                             ?>
                                <tbody>
                                    ...
                                    <tr class="table-striped" role="row" >
                                            ...
                                            <td class="hidden-print"> <input style="width: 20px;" type="checkbox" name ="ycs_ID" id="<?php if(isset($popdf)|| isset($dcpdf)|| isset($dcpdf2)){ echo "checkbox_".$sql_data_value[0] ; } else {echo "checkbox";} ?>" onclick=" <?php if(isset($popdf)){ echo 'downloadpdf(this.value,\'PDF\')';} if(isset($dcpdf)){ echo 'dcdownloadpdf(this.value,\'PDF\')'; } if(isset($dcpdf2)){ echo 'dcdownloadpdf2(this.value,\'PDF\')'; } ?> " value="<?php echo $sql_data_value[0]; ?>"></td>
