 ...
 *
 * @author gunabalans@netkathir.com
 */
class DBUTIL {
...
////////////////////////////////////////////////////
      ...
      *    $data = $dbutil->selectKeyVal('usertype') //here only table name usedm key and val are default values
      */
